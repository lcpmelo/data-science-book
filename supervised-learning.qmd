...
```{r}
# Carregando a planilha para a variável
url_da_planilha <- "https://docs.google.com/spreadsheets/d/1TXfLAFdW9s5dNN3xLO5eFinL5s6_oyzbPv7zVXWCyIk/edit?gid=0#gid=0"

# Criando um dataset com os dados da planilha
dados <- read_sheet(url_da_planilha, range = "E3:N194")
```
